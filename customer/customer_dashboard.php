    ...
    <head>
        ...
        <link rel="stylesheet" href="../customer/css/customer_dashboard.css">
    </head>
    <body>
                    ...
                    <tbody>
                        <?php while ($appointment = mysqli_fetch_assoc($appointmentQuery)): ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($appointment['status'] === 'Completed' && $appointment['payment_status'] === 'Unpaid'): ?>
                                        <span class="text-danger fw-bold">Please complete payment</span>
